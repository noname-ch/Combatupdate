...
import ch.bbcag.combatupdate.GipfaeliRecoil.Recoil;
...
public enum GipfaeliWeapon {
    ...
    RIFLEMAN(() -> CombatUpdate.LETONY_MATE_AK47.get(),
    ...
    ASSAULT(() -> CombatUpdate.GIPFAELI_SHOTGUN.get(),
    ...
    // squad with it.
    BOMBER(() -> CombatUpdate.GIPFAELI_LAUNCHER.get(),
    ...
    PANZER(() -> CombatUpdate.GIPFAELI_HEAVY_MG.get(),
    ...
    MARCHER(() -> CombatUpdate.GIPFAELI_WAR_BANNER.get(),
    ...
    public String key() {
        return "combatupdate.army.role." + this.token();
    }
