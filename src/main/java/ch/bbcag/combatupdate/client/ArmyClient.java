...
import ch.bbcag.combatupdate.GipfaeliArmyNetwork;
import ch.bbcag.combatupdate.GipfaeliArmyNetwork.OpenArmy;
...
public final class ArmyClient {
    public static final KeyMapping OPEN = new KeyMapping("key.combatupdate.army", InputConstants.KEY_K, TerritoryClient.CATEGORY);
