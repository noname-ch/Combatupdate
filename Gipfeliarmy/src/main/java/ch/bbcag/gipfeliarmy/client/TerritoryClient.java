...
public final class TerritoryClient {
    public static final KeyMapping.Category CATEGORY = new KeyMapping.Category(
            Identifier.fromNamespaceAndPath(GipfeliArmyMod.MODID, "main"));
    public static final KeyMapping OPEN = new KeyMapping("key.gipfeliarmy.territory", InputConstants.KEY_M, CATEGORY);
